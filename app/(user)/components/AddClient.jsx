...
export default function AddClient() {
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = [
      "date", "clientName", "nameOfOfw", "age", "sex", "contactNo",
      "jobsite", "position", "address", "purpose", "survey"
    ];
    ...
    try {
      ...
      // Replace with: await supabase.from("client_logs").insert([data])
  ...
  return (
    <div className="relative flex flex-col flex-1 gap-4 p-6 bg-gray-50">
      ...
      {/* MAIN FORM */}
      <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4 p-6 rounded-2xl border border-gray-300 bg-white">
        <div className="grid grid-cols-7 gap-4">
          ...
          {/* sex */}
          <div className="col-span-1 flex flex-col gap-1">
            <label htmlFor="sex" className="text-gray-500 text-sm font-medium">
              SEX
            </label>
            <select
              name="sex"
          ...
          <div className="col-span-4 flex flex-col gap-1">
            ...
            <span className="text-xs text-gray-500">
              CITY/MUNICIPALITY, PROVINCE (e.g. CALAPAN CITY, ORIENTAL MINDORO)
            </span>
          </div>
