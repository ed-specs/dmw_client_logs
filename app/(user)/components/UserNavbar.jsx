      ...
      <div className="group absolute left-0 top-0 z-50 h-full w-24 overflow-hidden bg-gray-900 text-white transition-[width] duration-200 hover:w-80 focus-within:w-80">
        ...
        {/* DMW LOGO */}
            <div className="flex items-center gap-4  py-2">
              ...
              <h1 className="hidden w-[180px] overflow-hidden leading-tight font-bold group-hover:flex group-focus-within:flex">
                  ...
                  {section.items.map((item, itemIdx) => {
                    ...
                    return (
                      <Link
                        key={itemIdx}
                        href={item.href}
                        className={`rounded-lg px-4 py-3 flex items-center gap-3 transition-colors duration-150 cursor-pointer ${
                          isActive
