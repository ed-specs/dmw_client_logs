...
export default function AdminClientDataTable({
  data,
  selectedProvince,
  dbJobsites = [],
  dbPositions = [],
    ...
    if (opt.id === "address") {
      ...
      if (selectedProvince === "MIMAROPA REGION") {
        ...
        outsideLogs.forEach((log) =>
          options.push(`${log.address}, ${log.province}`),
        );
  ...
  const filteredStats = {
    ...
    totalMales: filteredData.filter((log) => String(log.sex).toUpperCase() === "M")
      .length,
                  ...
                  {filter.id === "date" ? (
                    ...
                    <>
                      ...
                      {activeDropdown === filter.id && filter.options && (
                        <div className="absolute top-full left-0 mt-1 w-full bg-white border border-gray-300 rounded-md  z-50 max-h-60 overflow-y-auto">
                ...
                <div className="grid grid-cols-7 gap-4 py-4 rounded-2xl">
                  ...
                  <div className="col-span-2 flex flex-col gap-1">
                    ...
                    <input
                      ...
                      disabled
                      defaultValue={
                        modalState.data?.province || selectedProvince
                      }
                      className="px-4 py-2 text-sm rounded-lg border border-gray-300 outline-none bg-gray-100 text-gray-500 cursor-not-allowed"
                    />
                  </div>
                  ...
                  <div className="col-span-4 flex flex-col gap-1">
                    ...
                    >
                      ...
                      {ProvincePlaces.find(
                        ...
                        <option
                          key={place}
                          value={`${place}, ${modalState.data?.province || selectedProvince}`}
                        >
                          {place}
                        </option>
                      ))}
